...
export const DESIGN_STORIES: DesignStory[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "The back of the shirt carries its own layer, opening with a question — \"What Are You Searching For\" — arranged like the letters in a word search puzzle.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "The essence of the verse is finding peace and sufficiency in GOD, regardless of circumstances — a journey of growth that reveals true fulfillment comes from a personal relationship with GOD, not from external sources.",
        ],
      },
    ],
  },
  {
    ...
    symbolism:
      "The GEAR crest carries the shield of faith, the sword of the Spirit, and an anchor — each numbered letter of the acronym doubling as a piece of armor.",
    ...
    sections: [
      {
        heading: "The meaning",
        body: [
          "\"The Armor\" was inspired by the idea of putting on the full armor of GOD as described in Ephesians 6. The front of the shirt shows the acronym GEAR, with each letter followed by its corresponding number in the alphabet instead of a dot or other shape. GEAR has multiple meanings — in slang it means clothing, in other contexts it means equipment — and the title The Armor points directly to what GEAR is referring to here.",
        ],
      },
      {
